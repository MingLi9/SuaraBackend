package Suara.Suara.Filter;

import Suara.Suara.DAL.RoleDAL;
import Suara.Suara.DAL.SuaraUserDAL;
        ...
        if (request.getServletPath().equals("/login") || request.getServletPath().equals("/refresh")) {
            ...
            if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
                try {
                    ...
                    //Todo: replace the roles from the
                    // token with the roles retrieved from the dataset for more security
